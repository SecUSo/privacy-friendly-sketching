...
class BackupRestorer : IBackupRestorer {
    ...
    private fun readDatabase(@NonNull reader: JsonReader, @NonNull context: Context) {
        ...
        val databasePassword = EncryptionHelper.loadPassPhrase(context)
        ...
        val actualDatabaseFile = context.getDatabasePath(SketchingRoomDB.DATABASENAME)

        DatabaseUtil.deleteRoomDatabase(context, SketchingRoomDB.DATABASENAME)
